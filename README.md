...
LLM の Bonsai-8B は hugging face から gguf ひっぱってきて create してます。　小さいからテストに使うにはメモリも 16GB なのでこけなくていいです。
rust のコードはとりま devin AI の無料枠でだだっと作って gemini copilot でちまちま修正させて動かしてます。 devin AI は rust だとわりと簡単に土俵に乗せてくれる気がします。　c# だと Permision denyed とか連発でそこまで簡単にはいかない感じ。
